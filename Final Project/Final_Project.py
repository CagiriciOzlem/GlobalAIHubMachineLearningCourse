...
xgb_params = {"n_estimators":[100,500,200],
              "subsample":[0.6,0.8,1],
              "max_depth": [3,5],
...
xgb =  XGBClassifier(learning_rate = 0.01,subsample = 0.8,max_depth = 5,n_estimators = 2000,random_state = 42)
...
rf = RandomForestClassifier(n_estimators=500,max_features=8,min_samples_split=5)
...
print("F1 Score = {}".format(f1_score(Y_test, Y_pred,average='macro')))
 ...
 GlobalAIHubMachineLearningCourse/Final Project
